...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an [issue](https://github.com/KarthikChary1/Spam-Classifier-1-with-Deployment/issues) here by including your search query and the expected result
